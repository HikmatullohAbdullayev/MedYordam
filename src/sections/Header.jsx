        ...
        <div>
            ...
            <div className="header_main  flex justify-between items-center">
                    ...
                    <div className="flex justify-between py-[18px] px-[22px] rounded-2xl items-center bg-[#FFFFFF] desktop1350:py-[10px] tablemin845:px-[16px]">
                        {/* <Link > */}
                        <div className="">
                            <img className="w-[40px] tablemin845:w-[22px] tablemin845:py-[10px]" src={Logo} alt="logo" />
                        </div>
                        {/* </Link> */}
                        {/* <Link > */}
                        <h2 className="px-[20px]  text-[24px] font-bold tablemin845:text-[18px] tablemin845:px-[8px] mobile530:hidden">Med Yordam</h2>
                        {/* </Link> */}
                        <p className="text-[#747474] ml-[20px] desktop1220:hidden">Консультация <br/> от врачей</p>
                    </div>
                    <div className="category flex justify-between items-center gap-3 bg-[#0129E3] py-[30px] px-[60px] rounded-2xl cursor-pointer hover:bg-[#012ae3cb] active:bg-[#0526b7] focus:bg-[#0526b7] desktop1350:px-[20px]  desktop1350:py-[20px]   ">
                        <span><AppIcon/></span>
                        <button className="text-white text-[16px] table1005:hidden">Каталог услуг</button>
                    </div>
                        ...
                        <ul className="flex justify-between items-center gap-[26px] mobile3:gap-[14px]  ">
                           {
                            nav.map((link) =>(
                                <li key={link.id}>
                                    <p className="text-[16px] text-[#747474] hover:text-blue-600 cursor-pointer">{link.link}</p>
                                </li>
                            ))
                           }
                        </ul>
                    ...
                    <div className="py-[30px] px-[60px] rounded-2xl bg-white desktop1350:px-[16px]  desktop1350:py-[16px]">
                       <div className="regis  desktop1220:hidden">
                       <a className="text-[#0129E3] text-[16px] font-medium  " href="#">Вход </a>/ 
                        <a className="text-[#0129E3]  text-[16px] font-medium " href="#"> Регистрация</a>
                       </div>

                        <span className="hidden   hover:fill-blue-600 desktop1220:block"><LoginIcon/></span>
                    </div>
