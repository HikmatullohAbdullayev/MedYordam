    ...
    return (
        ...
        <section className="mt-[81px] flex justify-start items-start gap-[20px] mb-[160px]">
            ...
            <div className="w-full relative">
                <div className={`filterMob absolute  ${opeFilter ? " block" : "hidden"}  z-10` }>
                    
                    <Filter/>
                </div>
                <div className="top  py-[20px] flex justify-between items-center table1005:flex-col">
                    
                <h3 className="text-[50px] max-w-[700px]  font-medium px-[25px] desktop:text-[36px] table1080:text-[24px]">Список последних ответов на вопросы <span className="text-[#747474]"> (12 493)</span></h3>
                 <div className="flex gap-[20px] table1005:py-[20px] table1005:px-[20px]">
                 <button className="sort  flex items-center justify-between gap-[10px] bg-white rounded-2xl py-[20px] px-[40px] hover:bg-blue-400 hover:outline-blue-700 hover:fill-white outline-blue-600 ">
                    ...
                    <p className="text-[#747474] text-[14px] text-nowrap "> Сортировать по</p>
                </button>
                <button className="sort hidden ml-[10px]  items-center justify-between gap-[10px] bg-white rounded-2xl py-[20px] px-[40px] hover:bg-blue-400 hover:outline-blue-700 hover:fill-white outline-blue-600 table1080:flex " onClick={()=> burgerFilter()} >
                ...
                <div className=" flex justify-between items-center gap-[10px] w-full">
                    ...
                    <input className="w-full  py-[27.5px] px-[30px] rounded-xl border-transparent border-solid  outline-transparent hover:outline-blue-600 active:outline-blue-700 focus:outline-blue-600   desktop:py-[10px] desktop:px-[18px]" type="text" name="search" id="search" aria-label="search" placeholder="Искать по тексту в вопросе" value={searchTerm}
